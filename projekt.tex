...
%   author.title.p={Bc.}, % titul před jménem (nepovinné) / title before the name (optional)
  ...
  % Abstrakt / Abstract
  abstract.cs={Cieľom tejto práce je vývoj nástroja pre automatické generovanie testov v prostredí GNOME. Na generovanie testov sú použité metadáta assistečných technológií. Práca popisuje architektúru assistenčných technológií v tomto prostredí aj technológie, ktoré pokrývajú jej prípadné nedostatky. Časť práce je venovaná testovaniu grafických používateľkých rozraní, s následným návrhom implementácie nástroja na generovanie testov. Vygenerované testy sú vhodné na automatizované testovanie. },
