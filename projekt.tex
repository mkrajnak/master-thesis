...
\projectinfo{
  ...
  keywords.cs={testovanie grafických rozhraní, GNOME, generovanie testov, asistenčné technológie}, % klíčová slova v českém či slovenském jazyce / keywords in czech or slovak language
  keywords.en={GUI testing, GNOME, tests generation, accessibility technologies}, % klíčová slova v anglickém jazyce / keywords in english
